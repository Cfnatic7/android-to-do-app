...
public class MainActivity extends AppCompatActivity {
    ...
    private List<Task> initData() {
        ...
        tasks.add(new Task(1, "Buy groceries", "Buy milk, eggs, and bread", "2023-04-25"));
        tasks.add(new Task(2, "Finish project", "Finish the project by the end of the week", "2023-04-29"));
        tasks.add(new Task(3, "Pay bills", "Pay the electricity and water bills", "2023-04-30"));
        return tasks;
    }
